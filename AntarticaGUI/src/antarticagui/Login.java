 ...
 */
 ...
 import antarticagui.ImagePanel;
 import antarticagui.Main;
 import antarticagui.TextAreaOutputStream;
...
import java.awt.event.ActionEvent;
 ...
 public class Login extends javax.swing.JFrame {
     ...
     private void setLoginBackground(Dimension size){
         ...
         backgroundPanel = new antarticagui.ImagePanel(loginImage);
     ...
     private void loginButton(Dimension size){
         ...
         jButton1.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent e){
                 ...
                 if (antarticagui.Main.login(username, password)){
                     System.out.println("working");
                     System.out.println("Opening window");
                     antarticagui.User user = antarticagui.Main.users.get(antarticagui.Main.userLookup.get(username));
     ...
     private void registerButton(Dimension size){
         ...
         jButton2.addActionListener(new ActionListener() {
             public void actionPerformed(ActionEvent e){
                 ...
                 if(antarticagui.Main.registered(username)){
                     errorMessage("That username already exists");
                 }
                 else{
                     try {
                         antarticagui.Main.signUp(username, password);
                         antarticagui.User user = antarticagui.Main.users.get(antarticagui.Main.userLookup.get(username));
                         frame.dispose();
                         openHome(user);
     ...
     private void openDashboard(antarticagui.User u) throws IOException {
         ...
         antarticagui.ImagePanel backgroundPanel = new antarticagui.ImagePanel(generalImage);
         ...
         PrintStream outStream = new PrintStream( new antarticagui.TextAreaOutputStream(jTextArea1));
         ...
         jButton1.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent e) {
                 ...
                 //lookup book
                 if (antarticagui.Main.bookLookup.containsKey(temp[0])) {
                     u.rateBook(temp);
                     try {
                         antarticagui.Main.rewriteUsers();
                         jTextArea1.setText(null);
                         antarticagui.Main.userLookup.clear();
                         antarticagui.Main.users.clear();
                         antarticagui.Main.books.clear();
                         antarticagui.Main.getBook();
                         antarticagui.Main.checkMap();
                         antarticagui.Main.getTopBooks();
      ...
      private void openHome(antarticagui.User u) throws IOException {
          ...
          // Create an instance of ImagePanel with the second image
          antarticagui.ImagePanel backgroundPanel = new antarticagui.ImagePanel(homeImage);
          ...
          jButton2 = new JButton("Recommended");
         ...
         //Search button
          jButton3.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent e) {
                 ...
                 for (int i = 0; i < 10; i ++) {
                     System.out.println(antarticagui.Main.search(antarticagui.Main.books, desires).get(i));
                 }
             }
         });
         jButton4.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent e) {
                 ...
                 if (temp[0].equalsIgnoreCase("rate")) {
                     ...
                     if (antarticagui.Main.bookLookup.containsKey(temp2[0])) {
                         u.rateBook(temp2);
                         try {
                             antarticagui.Main.rewriteUsers();
                             jTextArea1.setText(null);
      ...
      private void openHelp() throws IOException {
          ...
          antarticagui.ImagePanel backgroundPanel = new antarticagui.ImagePanel(whiteImage);
     ...
     private void setRecBackground(){
         backgroundPanel = new antarticagui.ImagePanel(dashboardImage);
     ...
     private void openRec(User u) {
      ...
      private void openProfile(antarticagui.User u) throws IOException{
         ...
         jButton1.addActionListener(new ActionListener(){
             public void actionPerformed(ActionEvent e){
                 ...
                 if (antarticagui.Main.bookLookup.containsKey(input)) {
                     u.addHasRead(input);
                     System.out.println(input + " , " + u.rateList.get(antarticagui.Main.bookLookup.get(input)));
     ...
     private void setProfileBackground(User u){
         ...
         backgroundPanel = new antarticagui.ImagePanel(profileImage);
